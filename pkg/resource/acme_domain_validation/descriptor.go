...
const (
	FinalizerString = "finalizers.acm.services.k8s.aws/AcmeDomainValidation"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("acmedomainvalidations")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.AcmeDomainValidation{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.AcmeDomainValidation),
	}
}
