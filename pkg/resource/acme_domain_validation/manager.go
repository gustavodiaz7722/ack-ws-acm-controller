...
// +kubebuilder:rbac:groups=acm.services.k8s.aws,resources=acmedomainvalidations,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=acm.services.k8s.aws,resources=acmedomainvalidations/status,verbs=get;update;patch

var lateInitializeFieldNames = []string{"ExactDomain", "Subdomains", "Wildcards"}
...
func (rm *resourceManager) incompleteLateInitialization(
	...
	if ko.Spec.PrevalidationOptions != nil {
		if ko.Spec.PrevalidationOptions.DNSPrevalidation != nil {
			if ko.Spec.PrevalidationOptions.DNSPrevalidation.DomainScope != nil {
				if ko.Spec.PrevalidationOptions.DNSPrevalidation.DomainScope.ExactDomain == nil {
					return true
				}
			}
		}
	...
	if ko.Spec.PrevalidationOptions != nil {
		if ko.Spec.PrevalidationOptions.DNSPrevalidation != nil {
			if ko.Spec.PrevalidationOptions.DNSPrevalidation.DomainScope != nil {
				if ko.Spec.PrevalidationOptions.DNSPrevalidation.DomainScope.Subdomains == nil {
					return true
				}
			}
		}
	...
	if ko.Spec.PrevalidationOptions != nil {
		if ko.Spec.PrevalidationOptions.DNSPrevalidation != nil {
			if ko.Spec.PrevalidationOptions.DNSPrevalidation.DomainScope != nil {
				if ko.Spec.PrevalidationOptions.DNSPrevalidation.DomainScope.Wildcards == nil {
					return true
				}
			}
		}
...
func (rm *resourceManager) lateInitializeFromReadOneOutput(
	...
	if observedKo.Spec.PrevalidationOptions != nil && latestKo.Spec.PrevalidationOptions != nil {
		if observedKo.Spec.PrevalidationOptions.DNSPrevalidation != nil && latestKo.Spec.PrevalidationOptions.DNSPrevalidation != nil {
			if observedKo.Spec.PrevalidationOptions.DNSPrevalidation.DomainScope != nil && latestKo.Spec.PrevalidationOptions.DNSPrevalidation.DomainScope != nil {
				if observedKo.Spec.PrevalidationOptions.DNSPrevalidation.DomainScope.ExactDomain != nil && latestKo.Spec.PrevalidationOptions.DNSPrevalidation.DomainScope.ExactDomain == nil {
					latestKo.Spec.PrevalidationOptions.DNSPrevalidation.DomainScope.ExactDomain = observedKo.Spec.PrevalidationOptions.DNSPrevalidation.DomainScope.ExactDomain
				}
			}
		}
	}
	if observedKo.Spec.PrevalidationOptions != nil && latestKo.Spec.PrevalidationOptions != nil {
		if observedKo.Spec.PrevalidationOptions.DNSPrevalidation != nil && latestKo.Spec.PrevalidationOptions.DNSPrevalidation != nil {
			if observedKo.Spec.PrevalidationOptions.DNSPrevalidation.DomainScope != nil && latestKo.Spec.PrevalidationOptions.DNSPrevalidation.DomainScope != nil {
				if observedKo.Spec.PrevalidationOptions.DNSPrevalidation.DomainScope.Subdomains != nil && latestKo.Spec.PrevalidationOptions.DNSPrevalidation.DomainScope.Subdomains == nil {
					latestKo.Spec.PrevalidationOptions.DNSPrevalidation.DomainScope.Subdomains = observedKo.Spec.PrevalidationOptions.DNSPrevalidation.DomainScope.Subdomains
				}
			}
		}
	}
	if observedKo.Spec.PrevalidationOptions != nil && latestKo.Spec.PrevalidationOptions != nil {
		if observedKo.Spec.PrevalidationOptions.DNSPrevalidation != nil && latestKo.Spec.PrevalidationOptions.DNSPrevalidation != nil {
			if observedKo.Spec.PrevalidationOptions.DNSPrevalidation.DomainScope != nil && latestKo.Spec.PrevalidationOptions.DNSPrevalidation.DomainScope != nil {
				if observedKo.Spec.PrevalidationOptions.DNSPrevalidation.DomainScope.Wildcards != nil && latestKo.Spec.PrevalidationOptions.DNSPrevalidation.DomainScope.Wildcards == nil {
					latestKo.Spec.PrevalidationOptions.DNSPrevalidation.DomainScope.Wildcards = observedKo.Spec.PrevalidationOptions.DNSPrevalidation.DomainScope.Wildcards
				}
			}
		}
	}
